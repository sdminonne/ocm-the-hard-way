...
wait_until "deployment_up_and_running hub open-cluster-management cluster-manager" 5 30

kubectl --context=${HUBCONTEXT} create namespace open-cluster-management-hub
wait_until "namespace_active hub open-cluster-management-hub"
...
cat artifacts/hub/open-cluster-management-hub/cluster-manager-work-webhook-list-template.yaml | \
 ...
 wait_until "deployment_up_and_running hub open-cluster-management-hub cluster-manager-work-webhook" 5 30
...
wait_until "deployment_up_and_running hub open-cluster-management-hub cluster-manager-registration-webhook" 5 30
